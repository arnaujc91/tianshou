...
from tianshou.env.venvs import CartPoleForGRPO
...
def test_grpo(args: argparse.Namespace = get_args(), enable_assertions: bool = True) -> None:
    ...
    train_envs = DummyVectorEnv([lambda initial_state=initial_state: CartPoleForGRPO(initial_state) for initial_state in initial_states_array])
